...
`;
  ...
  const I18N = {
    ru: {
      ...
      printBtn: "Распечатать результаты",
      printTitle: "Порядок печати тетрадей",
      signatureN: "Тетрадь {n}",
      frontSide: "Лицо",
      backSide: "Оборот",
      progressLabel: "Напечатано: {done} из {total} сторон",
      allDone: "Все тетради напечатаны ✓",
      copyPages: "Скопировать",
      copyTooltip: "Скопировать список страниц",
      copied: "Скопировано ✓",
      side1: "Сторона 1",
      side2: "Сторона 2",
      booklet: "Тетрадь",
    ...
    en: {
      ...
      printTitle: "Booklet Print Order",
      signatureN: "Signature {n}",
      frontSide: "Front",
      backSide: "Back",
      progressLabel: "Printed: {done} of {total} sides",
      allDone: "All signatures printed ✓",
      copyPages: "Copy",
      copyTooltip: "Copy page list",
      copied: "Copied ✓",
      side1: "Side 1",
      side2: "Side 2",
      booklet: "Booklet",
